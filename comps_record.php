  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand">Records - Computer <i class="fas fa-laptop-code"></i></a>
      ...
      <table>
        ...
        <tbody id="output">
          ...
          <tr style="border-bottom: 2px solid #99D98C;">
            ...
            <td><a href="comps_receipt.php?id= <?php echo $rows['id'] ;?>"> 
              <button type="button" class="btn5 px-3 btn-sm">Get Receipt</button></a>
            </td> 
          </tr>
          <?php
          }
