...
if(isset($_POST['save']))
{
  ...
  $sql = "SELECT * from comps where id=$from";
  ...
  else
  {
    ...
    $sql = "UPDATE comps set balance=$newbalance where id=$from";
    ...
    $sql = "INSERT INTO paycomps(`id`,`name`,`contact`,`email`,`joindate`, `paid`, `remark`, `datetime`) VALUES ('$from','$student','$contact','$email','$joindate','$paid','$remark','$datetime')";
    $query=mysqli_query($conn,$sql);

    if($query)
    {
      echo "<script> alert('Fees has been updated');
      window.location='comps_record.php';
      </script>"; 
    }
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="comps.php">Back <i class="fas fa-arrow-circle-left"></i></a>
            </li>
            <li class="nav-item">
    ...
    <div class="d-flex w-100 h-100 p-3 mx-auto flex-column">
      <main class="px-3 mb-0">
        <div class="container" style="padding-top:80px">
          ...
          include 'connection.php';
          $sid=$_GET['id'];
          $sql = "SELECT * FROM  comps where id=$sid";
