  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand">List of Students - EXTC <i class="fas fa-broadcast-tower"></i></a>
      ...
      <table>
        ...
        <tbody id="output">
          ...
          <tr style="border-bottom: 2px solid #99D98C;">
            ...
            <td><a href="payextc.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn5 px-3 btn-sm">Fee Details</button></a></td> 
          </tr>
          <?php
          }
          ?>
