...
$sql = "SELECT * FROM mechanical WHERE name LIKE '%".$_POST['name']."%'";
...
if(mysqli_num_rows($result)>0){
	while ($row=mysqli_fetch_assoc($result)) {
		...
		<tr style="border-bottom: 2px solid #99D98C;">
			...
			<td><a href="paymech.php?id= <?php echo $row['id'] ;?>"> <button type="button" class="btn5 px-3 btn-sm">Fee Details</button></a></td> 
	  	</tr>	
	<?php
	}
	?>
